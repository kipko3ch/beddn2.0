  ...
  return (
    <main className="max-w-lg mx-auto px-4 py-8">
      <div className="flex items-center gap-2 mb-4">
        {isConfirmed ? (
          <CheckCircle className="h-6 w-6 text-crimson" />
        ) : (
        ...
        {isConfirmed ? (
          <div className="space-y-3">
            <div className="flex items-start gap-2">
              <MapPin className="h-4 w-4 mt-0.5 text-crimson" />
              <div>
            ...
            <div className="flex items-start gap-2">
              <Phone className="h-4 w-4 mt-0.5 text-crimson" />
              <div>
            ...
            {booking.listing.check_in_instructions && (
              <div className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 mt-0.5 text-crimson" />
                <div>
                  <span className="text-sm text-muted-foreground">
      ...
      {booking.status === "completed" && (
        <form onSubmit={submitFeedback} className="border rounded-xl p-5 mt-4 space-y-3">
          ...
          {feedbackSent ? (
            <p className="text-sm text-cranberry">Thanks. Your feedback helps Beddn launch better.</p>
          ) : (
            <>
